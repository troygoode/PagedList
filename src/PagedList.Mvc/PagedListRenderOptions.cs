...
namespace PagedList.Mvc
{
    ...
    public class PagedListRenderOptions
    {
        ...
        /// <summary>
        /// Includes links to First and Last pages and shows the total number of items across all pages.
        /// </summary>
        public static PagedListRenderOptions ClassicPlusFirstAndLastWithItemCountText
        {
            get
            {
                return new PagedListRenderOptions
        ...
        /// <summary>
        /// Also includes labeled links to First and Last pages if needed.
        /// </summary>
        public static PagedListRenderOptions ModernPlusFirstAndLast
        {
            get
            {
                return new PagedListRenderOptions
